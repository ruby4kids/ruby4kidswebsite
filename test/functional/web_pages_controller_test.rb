...
class WebPagesControllerTest < ActionController::TestCase
  ...
  test "should create web_page" do
    assert_difference('WebPage.count') do
      post :create, web_page: { content: @web_page.content, status: @web_page.status, title: @web_page.title, url: @web_page.url }
    end
  ...
  test "should update web_page" do
    put :update, id: @web_page, web_page: { content: @web_page.content, status: @web_page.status, title: @web_page.title, url: @web_page.url }
    assert_redirected_to web_page_path(assigns(:web_page))
  end
